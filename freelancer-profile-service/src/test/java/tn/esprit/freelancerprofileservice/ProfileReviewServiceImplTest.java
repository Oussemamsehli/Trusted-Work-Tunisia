...
import tn.esprit.freelancerprofileservice.services.ProfileReviewServiceImpl;
import tn.esprit.freelancerprofileservice.services.ReviewAnalysisResult;
import tn.esprit.freelancerprofileservice.services.ReviewAnalysisService;
...
class ProfileReviewServiceImplTest {
    ...
    void shouldThrowExceptionWhenClientReviewsOwnProfile() {
        addReviewRequest.setClientId(100L); // même user que le propriétaire du profil
